...
<html lang="en">
    ...
    <style>
      ...
      <div class="signup">
        ...
        <tr>
        <td align= "center"><h3 style="font-family: 'times new roman'; font-size: 12px; color: black; position:absolute; right: 580px;"> Go back? <a style="font-family: 'times new roman'; color:white; " href="home.php";> here </h3></center></td>
        </tr>
