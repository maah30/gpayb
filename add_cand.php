...
if ($_SERVER['REQUEST_METHOD'] == "POST") 
{
    ...
    $query_check = "SELECT * FROM candidatess WHERE cand_ID = ?";
    ...
    if (mysqli_num_rows($result_check) > 0) 
    {
     ...
     {
        $query_check_id = "SELECT * FROM candidatess WHERE cand_ID = ?";
        ...
        {
                $query_stud_info = "INSERT INTO candidatess (cand_ID, cand_name, position) VALUES ( ?, ?, ?)";
...
<html lang="en">
    ...
    <style>
      ...
      <div class="signup">
        ...
        <tr>
        <td align= "center"><h3 style="font-family: 'times new roman'; font-size: 12px; color: white; position:absolute; right: 635px;"> <a style="font-family: 'times new roman'; color:black;" href="brgy_cand.php";>Go back?  </h3></center></td>
        </tr>
