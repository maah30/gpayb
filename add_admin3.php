...
<html lang="en">
    ...
    <style>
      ...
      <div class="signup">
        ...
        <tr>
        <td align= "center"><h3 style="font-family: 'times new roman'; font-size: 12px; color: white; position:absolute; right: 635px;"> <a style="font-family: 'times new roman'; color:black;" href="admin_login.php";>Go back?  </h3></center></td>
        </tr>
